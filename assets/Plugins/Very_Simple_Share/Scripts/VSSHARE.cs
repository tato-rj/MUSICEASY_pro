	...
	public class VSSHARE: MonoBehaviour  
	{
		...
		public void OnClickedOnIconScreenshot()
		{
			...
			else
			{
				...
				{
					ShareScreenshot(ShareText, ShareType.Native);
				}
...
//			GetComponent<RectTransform>().localPosition = Vector2.zero;
		...
		{
			ShareScreenshot(ShareText, ShareType.Facebook);
		}

		public void OnClickedOnTwitter()
		{
			ShareScreenshot(ShareText, ShareType.Twitter);
		}

		public void OnClickedOnWhatsapp()
		{
			ShareScreenshot(ShareText, ShareType.Whatsapp);
		}
